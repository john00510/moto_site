...
import MakeModelFlyout from './make_model_flyout';

class MakeModelLayout extends React.Component {
  render() {
    return (
          <div className={this.props.el1} onClick={this.props.onClick}>
            ...
            <div className={this.props.el3}>{MakeModelFlyout}</div>
          </div>
    );
  }
}

export default MakeModelLayout;
