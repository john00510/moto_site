...
const mobileNav = (
  <nav className="page-header--mobile-nav">
    <ul className="page-header--mobile-nav--list">
      <li className="page-header--mobile-nav--list--item  page-header--mobile-nav--list--my-store-item">
        <div className="my-store--container" data-mystore-id="02ef1691-f949-45a3-8eea-27e946b6e1bd">
          <div className="my-store--store-label">Your Store</div>
          <a className="my-store--store-name" data-kmx="my-store-button">
            ...
            <span className="btn--pill--text" data-kmx="my-store-name">Lynnwood, WA</span>
          </a>
  ...
  L2.417,5.197z"></path>
            ...
            <span className="btn--pill--text" data-kmx="my-store-phone">(425) 412-1290</span>
          </span>
          <div className="my-store-flyout" data-kmx="my-store-flyout">
            <div>
              <div className="my-store-flyout--section">
                ...
                <a className="my-store-flyout--section-action my-store-flyout--store-name" href="https://www.carmax.com/stores/7250">
                  <h4 className="my-store-flyout--store-name" data-kmx="my-store-flyout-store-name">Lynnwood</h4>
                </a>
                <div className="my-store-flyout--section-content">
                  <span data-kmx="my-store-flyout-store-address">21317 Highway 99
                    <br />Lynnwood,
                  ...
                  <span data-kmx="my-store-flyout-store-phone">(425) 412-1290</span>
                </div>
                <div className="my-store-flyout--section-content"></div>
                <h4 className="my-store-flyout--section-title">Showroom hours</h4>
                <div className="my-store-flyout--section-content" data-kmx="my-store-flyout-showroom-hours">
            ...
            <div className="my-store-flyout--search">
              ...
              <form>
                <input autocomplete="off" className="lead-form--field" data-kmx="my-store-flyout-search-input" placeholder="Enter ZIP or State" type="text" />
                  <button className="my-store-flyout--search--action" data-kmx="my-store-flyout-search-button">
      ...
      <li className="page-header--mobile-nav--list--item">
        <a href="https://www.carmax.com/mycarmax/saved-cars" className="sticky--my-carmax--link">
          <span className="sticky--my-carmax--saved-cars--total">
            <span>0</span>
          </span>
          <svg className="sticky--my-carmax--heart" role="img" id="" viewBox="0 0 13.036 10.992">
            <path d="M11.12.303C9.458-.454 7.287.258 6.518 1.891 5.75.258 3.578-.455 1.917.303.148 1.111-.698 3.176.7 5.612c.991 1.733 2.75 3.039 5.818 5.38 3.068-2.341 4.827-3.648 5.818-5.38 1.398-2.436.552-4.501-1.216-5.309z"></path>
          </svg>
          <img className="global-nav--my-carmax--header--icon sticky--my-carmax--car" src="CarMax%20-%20Browse%20used%20cars%20and%20new%20cars%20online_files/car.svg" alt="car" />
        </a>
      </li>
    </ul>
  </nav>
...
const globalNav = (
  <div className="global-nav">
    <ul className="global-nav--list" data-js="jsToggle">
      <li className="global-nav--item global-nav--item-has-subnav" id="buysMenu">
        <a className="global-nav--link" href="https://www.carmax.com/cars">Cars For Sale</a>
        <span className="global-nav--link global-nav--link-mobile">Cars For Sale</span>


      </li>
      <li className="global-nav--item global-nav--item-has-subnav" id="sellsMenu">
        <a className="global-nav--link" href="https://www.carmax.com/sell-my-car">Sell Your Car</a>
        <span className="global-nav--link global-nav--link-mobile">Sell Your Car</span>


      </li>
      <li className="global-nav--item global-nav--item-has-subnav" id="financeMenu">
        <a className="global-nav--link" href="https://www.carmax.com/car-financing">Financing</a>
        <span className="global-nav--link global-nav--link-mobile">Financing</span>


      </li>
      <li className="global-nav--item global-nav--item-has-subnav" id="researchMenu">
        <a className="global-nav--link" href="https://www.carmax.com/research">Research</a>
        <span className="global-nav--link global-nav--link-mobile">Research</span>
        ...
        <div style={{ height: "100%" }}>
          ...
          <ul className="global-nav--item--subnav--list global-nav--my-carmax--header--sub-navigation global-nav--item--subnav-my-carmax">
            <li className="global-nav--item--subnav--list--item global-nav--my-carmax--login-register global-nav--my-carmax--login-link">
              <a href="https://www.carmax.com/mycarmax/sign-in" data-kmx="global-login" title="Log In" className="global-nav--my-carmax--link">Sign In
              </a>
            </li>
            <li className="global-nav--item--subnav--list--item global-nav--my-carmax--login-register">

              <a href="https://www.carmax.com/mycarmax/register" className="global-nav--my-carmax--link" title="Register">Register</a>
            </li>
            <li className="global-nav--item--subnav--list--item global-nav--my-carmax--payment--title">
              <a href="https://www4.carmax.com/account/summary" className="global-nav--my-carmax--link" title="Make a Payment">Make a Payment</a>
            </li>
            <li className="global-nav--item--subnav--list--item global-nav--my-carmax--saved-cars">
              <a href="https://www.carmax.com/mycarmax/saved-cars" className="global-nav--my-carmax--link">
                <span>
            ...
            <div className="global-nav--my-carmax--dropdown">
              <ul className="global-nav--item--subnav--list global-nav--my-carmax--dropdown--nav global-nav--my-carmax--header--sub-navigation">
                <li className="global-nav--item--subnav--list--item global-nav--my-carmax--dropdown--nav--link">
                  <a href="https://www.carmax.com/mycarmax/saved-searches" className="global-nav--my-carmax--link">
                    <span>
                      <svg className="global-nav--my-carmax--saved-searches--icon" role="img" id="search" viewBox="0 0 29.013 29.013">
...
C18.132,12.223,17.742,13.464,17.107,14.543z"></path>
                      </svg>
                    </span>
                ...
                <li className="global-nav--item--subnav--list--item global-nav--my-carmax--dropdown--nav--link">
                  <a href="https://www.carmax.com/mycarmax/profile" className="global-nav--my-carmax--link">
                    <span>
                      <svg className="global-nav--my-carmax--profile--icon" role="img" id="profile" viewBox="0 0 23 30">
...
C23,21.29,18.018,15.004,11.5,15.004z M3.058,27.721C3.283,22.038,6.91,17.665,11.5,17.665s8.217,4.373,8.441,10.056H3.058z"></path>
                      </svg>
                    </span>
