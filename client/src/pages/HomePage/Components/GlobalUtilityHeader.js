...
const GlobalUtilityHeader = () => (
  <ul dataReactroot = "" className = "page-header--utility-nav--list" >
    ...
    C18.132,12.223,17.742,13.464,17.107,14.543z"></path>
          ...
          <div className="flyout ">
            <form className="search-box" data-kmx="free-text-search">
              <div>
                <div className="search-box--wrap">
                  ...
                  <button type="submit" className="search-box--wrap--btn" data-kmx="free-text-search-submit">Go</button>
                  <nav></nav>
                </div>
              </div>
            </form>
    ...
    <li className="page-header--utility-nav--item">
      <div className="my-store--container" data-mystore-id="40ac9cd1-389f-4e92-831c-d9885ae956fe">
